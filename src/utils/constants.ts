...
export const RED = 0xeeff0000;
export const LIGHT_RED = 0x55ff0000;
export const BLACK = 0xff000000;
export const GREY = 0xff404040;

export const towerPositions: object[] = [];
export const maxNumberOfTowers = 5;
